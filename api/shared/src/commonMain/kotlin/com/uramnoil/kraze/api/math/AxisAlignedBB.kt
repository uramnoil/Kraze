 ...
 */
fun FloatVector3D.vectorWhenXIsOnLine(other: FloatVector3D, x: Float): FloatVector3D? {
 ...
 */
fun FloatVector3D.vectorWhenYIsOnLine(other: FloatVector3D, y: Float): FloatVector3D? {
 ...
 * @return vector with y set or null when y is not on a line with this and the other vector
 */
fun FloatVector3D.vectorWhenZIsOnLine(other: FloatVector3D, z: Float): FloatVector3D? {
    val xDiff: Float = other.x - x
    val yDiff: Float = other.y - y
